...
class PseudocodeLexer(RegexLexer):
    ...
    tokens = {
        ...
        'core':[ # Statements
                 (r'\b(inicio|fin|si|fsi|entonces|sino|fin[_ ]si|tant[ _]que|mietras|fin[ _]mientras|hacer|repetir'
                  r'repeter|type|structure|fin[ _]structure|fonction|procédure|procedure|retourner|renvoyer|'
                  r'para|fin[ _]para|hasta|déclarations?|juqsque|spécialise|specialise|comporte|super|public'
                  r'|D.V.|privé|protégé|caso|vale|fcaso|fpara|desde|a|inc|faccion|leer|escribir|'
                  r'classe|mientras|fmientras'
                  r')\s*\b', Keyword),

                 # Data Types
                 (r'\b(entero?|caracter?|real?|caracteres?|booleano?|cadena?|'
